...
baton_minip = tkinter.PhotoImage(file="ggg/button_0.png")
baton_minid = tkinter.PhotoImage(file="ggg/button_1.png")
baton_minin = tkinter.PhotoImage(file="ggg/button_2.png")
baton_minini = tkinter.PhotoImage(file="ggg/button_3.png")
baton_minnnni = tkinter.PhotoImage(file="ggg/button_4.png")
baton_minnni = tkinter.PhotoImage(file="ggg/button_5.png")
baton_minni = tkinter.PhotoImage(file="ggg/button_6.png")
baton_minnig7 = tkinter.PhotoImage(file="ggg/button_7.png")
baton_minnig8 = tkinter.PhotoImage(file="ggg/button_8.png")
baton_minnig9 = tkinter.PhotoImage(file="ggg/button_9.png")

baton_mini_ultra_555 = tkinter.PhotoImage(file="ggg/button_plus.png")
baton_minio = tkinter.PhotoImage(file="ggg/button_dot.png")
baton_minim = tkinter.PhotoImage(file="ggg/button_eq.png")
baton_minimy = tkinter.PhotoImage(file="ggg/button_div.png")
baton_minnig = tkinter.PhotoImage(file="ggg/button_minus.png")
baton_minnigx = tkinter.PhotoImage(file="ggg/button_multi.png")
